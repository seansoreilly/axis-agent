...
export class Agent {
  ...
  private buildExtendedPrompt(): string {
    return [
      ...
      "You have Zapier MCP configured with 24 tools: Google Calendar (find/get events, busy periods, calendars),",
      "Gmail (find/draft/label/archive/delete email, get attachments), Google Contacts (find/create/update contacts,",
      "groups, photos), and Trello (find actions/boards/labels/lists, card attachments). Use these tools directly.",
      "",
