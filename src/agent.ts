...
export class Agent {
  ...
  private buildCorePrompt(): string {
    ...
    return [
      ...
      `- Tools: Read, Write, Edit, Bash, Glob, Grep, WebSearch, WebFetch, Task, Zapier MCP (mcp__zapier__*)`,
  ...
  private buildExtendedPrompt(): string {
    return [
      ...
      "groups, photos), and Trello (find actions/boards/labels/lists, card attachments).",
