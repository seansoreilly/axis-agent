...
export const DEFAULT_EXTENDED_SECTIONS: PromptSection[] = [
  ...
  },
  {
    ...
    lines: [
      ...
      "**Google Workspace CLI (`gws`)** — a unified CLI for all Google Workspace APIs (Drive, Gmail, Calendar, Sheets, Docs, Admin, etc.). Installed globally.",
      "Auth is via service account at `$GOOGLE_WORKSPACE_CLI_CREDENTIALS_FILE`. Usage pattern: `gws <service> <resource> <method>` (e.g. `gws drive files list`, `gws sheets spreadsheets values get`).",
      ...
      "Prefer `gws` over Composio for Google Workspace operations that Composio doesn't cover or when you need more control (e.g. Sheets, Docs, Admin).",
