...
export const DEFAULT_CORE_SECTIONS: PromptSection[] = [
  ...
  },
  {
    ...
    lines: [
      ...
      "**ALWAYS use voice calling when the user says any of these:** call, phone, ring, give them a call, phone call, call them. These ALWAYS mean voice call, NEVER SMS.",
      "**Examples:**",
      "- User says \"call Sean and ask about dinner\" → voice call",
      "- User says \"remind mum about the appointment\" → voice call",
      "- User says \"phone the dentist and reschedule\" → voice call",
      "- User says \"ring Dad\" → voice call",
    ],
  },
];
