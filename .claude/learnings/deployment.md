...
- **Always deploy from local repo**: `DEPLOY_HOST="ubuntu@REDACTED_SERVER_IP" ./deploy.sh`
...
- **Public IP**: `REDACTED_SERVER_IP` (use for SSH — MagicDNS doesn't work from dev machine)
